//
//  FitnesStepsGraph.swift
//  MinimalAnimation-2
//
//  Created by Michele Manniello on 20/03/22.
//

import SwiftUI

struct FitnesStepsGraphView: View {
    var body: some View {
        VStack(spacing: 15){
            Text("Steps by hours")
                .fontWeight(.semibold)
...
//            Bar Graph
        ...
        .padding(.vertical,25)
        .background(RoundedRectangle(cornerRadius: 25, style: .circular).fill(.ultraThinMaterial))
    }
}

struct FitnesStepsGraphView_Previews: PreviewProvider {
                ...
                HStack{
                    ForEach(steps.indices,id:\.self){index in
                        ...
                        VStack(spacing:0){
                            ...
                            Text(
                                step.key.replacingOccurrences(of: " AM", with: "")
